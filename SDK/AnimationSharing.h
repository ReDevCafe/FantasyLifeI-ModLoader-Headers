...
public:
	...
	// void ProcessActorState(int32_t& OutState, class AActor* InActor, char currentState, char OnDemandState, bool& bShouldProcess); // [0x806d4b0] Native|Event|Public|HasOutParms|BlueprintEvent 
	// Function /Script/AnimationSharing.AnimationSharingStateProcessor.GetAnimationStateEnum
	// class UEnum* GetAnimationStateEnum();                                                                                    // [0x806d2f0] Native|Event|Public|BlueprintEvent 
};
...
public:
	...
	// void GetInstancedActors(TArray<AActor*>& Actors);                                                                        // [0x806d320] Final|Native|Protected|HasOutParms|BlueprintCallable 
};
...
public:
	...
	// void RegisterActorWithSkeletonBP(class AActor* InActor, class USkeleton* SharingSkeleton);                               // [0x806d670] Final|Native|Public|BlueprintCallable 
	// Function /Script/AnimationSharing.AnimationSharingManager.GetAnimationSharingManager
	// class UAnimationSharingManager* GetAnimationSharingManager(class UObject* WorldContextObject);                           // [0x806d190] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/AnimationSharing.AnimationSharingManager.CreateAnimationSharingManager
	// bool CreateAnimationSharingManager(class UObject* WorldContextObject, class UAnimationSharingSetup* Setup);              // [0x806d090] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/AnimationSharing.AnimationSharingManager.AnimationSharingEnabled
	// bool AnimationSharingEnabled();                                                                                          // [0x806d060] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
};
