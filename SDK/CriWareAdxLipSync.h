...
public:
	...
	// void SetSilenceThreshold(float VolumeDb);                                                                                // [0x619eb70] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareAdxLipSync.LipsAnalyzerBase.SetSamplingRate
	// void SetSamplingRate(int32_t SamplingRateHz);                                                                            // [0x619eae0] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareAdxLipSync.LipsAnalyzerBase.IsAtSilence
	// bool IsAtSilence();                                                                                                      // [0x619eab0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareAdxLipSync.LipsAnalyzerBase.Init
	// void Init(int32_t MaxInputSamplingRate, ELipsAnalyzerDataReadoutMode dataReadoutMode);                                   // [0x619e9e0] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareAdxLipSync.LipsAnalyzerBase.GetVolume
	// float GetVolume();                                                                                                       // [0x619e9a0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareAdxLipSync.LipsAnalyzerBase.GetSilenceThreshold
	// float GetSilenceThreshold();                                                                                             // [0x619e960] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareAdxLipSync.LipsAnalyzerBase.GetMorphTargetBlendAmountAsJapanese
	// FCriLipsMorphTargetBlendAmountAsJapanese GetMorphTargetBlendAmountAsJapanese();                                          // [0x619e900] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareAdxLipSync.LipsAnalyzerBase.GetInfoAtSilence
	// FCriLipsMouthInfo GetInfoAtSilence();                                                                                    // [0x619e8a0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareAdxLipSync.LipsAnalyzerBase.GetInfo
	// FCriLipsMouthInfo GetInfo();                                                                                             // [0x619e840] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	// void SetReadoutOffset(int64_t offsetMs);                                                                                 // [0x619f100] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareAdxLipSync.LipsAtomAnalyzer.IsAttached
	// bool IsAttached();                                                                                                       // [0x619f0c0] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareAdxLipSync.LipsAtomAnalyzer.GetReadoutStatus
	// ELipsAtomAnalyzerReadoutStatus GetReadoutStatus();                                                                       // [0x619f090] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareAdxLipSync.LipsAtomAnalyzer.GetProcessStatus
	// ELipsAtomAnalyzerProcessStatus GetProcessStatus();                                                                       // [0x619f060] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CriWareAdxLipSync.LipsAtomAnalyzer.Detach
	// void Detach();                                                                                                           // [0x619f040] Final|Native|Public|BlueprintCallable 
	// Function /Script/CriWareAdxLipSync.LipsAtomAnalyzer.Attach
	// void Attach(class UAtomComponent* InAtomComponent);                                                                      // [0x619efb0] Final|Native|Public|BlueprintCallable 
};
