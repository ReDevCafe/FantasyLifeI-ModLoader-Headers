...
public:
	...
	// void ExportToDisk(class UTexture* Texture, FString Filename, FImageWriteOptions& OPTIONS);                               // [0x42ed2c0] Final|RequiredAPI|Native|Static|Public|HasOutParms|BlueprintCallable 
};
