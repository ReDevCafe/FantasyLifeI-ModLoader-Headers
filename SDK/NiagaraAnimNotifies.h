...
public:
	...
	// class UFXSystemComponent* GetSpawnedEffect(class UMeshComponent* meshComp);                                              // [0x7208c70] Final|RequiredAPI|Native|Public|BlueprintCallable|Const 
};
...
public:
	...
	// float GetNotifyProgress(class UMeshComponent* meshComp);                                                                 // [0x7208bd0] Final|RequiredAPI|Native|Public|BlueprintCallable|Const 
};
...
public:
	...
	// class UFXSystemComponent* GetSpawnedEffect();                                                                            // [0x516bbf0] Final|RequiredAPI|Native|Public|BlueprintCallable|Const 
};
