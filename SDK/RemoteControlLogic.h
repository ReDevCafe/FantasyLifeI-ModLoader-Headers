...
{ 
public:
	SDK_UNDEFINED(80,1221) /* TSet<URCActionContainer*> */ __um(ActionContainers);                                 // 0x0028   (0x0050)  
	...
	SDK_UNDEFINED(80,1222) /* TSet<URCAction*> */      __um(Actions);                                              // 0x0098   (0x0050)  
};
...
public:
	...
	// void OnPassed(class URCBehaviour* InBehaviour);                                                                          // [0x4f3a330] Native|Event|Public|BlueprintCallable|BlueprintEvent|Const 
	// Function /Script/RemoteControlLogic.RCBehaviourBindNode.IsSupported
	// bool IsSupported(class URCBehaviour* InBehaviour);                                                                       // [0x73be550] Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	// Function /Script/RemoteControlLogic.RCBehaviourBindNode.Execute
	// bool Execute(class URCBehaviour* InBehaviour);                                                                           // [0x73be4b0] Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
};
...
public:
	...
	// void PreExecute(class URCBehaviour* InBehaviour);                                                                        // [0x73be730] Native|Event|Public|BlueprintCallable|BlueprintEvent|Const 
	...
	// bool IsSupported(class URCBehaviour* InBehaviour);                                                                       // [0x73be5f0] Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
...
public:
	...
	// bool IsSupported(class URCBehaviour* InBehaviour);                                                                       // [0x73be690] Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	// Function /Script/RemoteControlLogic.RCBehaviourOnValueChangedNode.Execute
	// bool Execute(class URCBehaviour* InBehaviour);                                                                           // [0x73be550] Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
};
...
public:
	...
	SDK_UNDEFINED(80,1223) /* TSet<URCBehaviour*> */   __um(Behaviours);                                           // 0x00E0   (0x0050)  
};
...
public:
	...
	SDK_UNDEFINED(80,1224) /* TSet<URCActionContainer*> */ __um(SharedActionContainers);                           // 0x0108   (0x0050)  
};
...
public:
	...
	// void TestIntFunction();                                                                                                  // [0x73be7c0] Final|Native|Public|BlueprintCallable 
};
