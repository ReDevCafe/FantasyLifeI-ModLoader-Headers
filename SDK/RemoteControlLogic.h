...
{ 
public:
	SDK_UNDEFINED(80,1237) /* TSet<URCActionContainer*> */ __um(ActionContainers);                                 // 0x0028   (0x0050)  
	...
	SDK_UNDEFINED(80,1238) /* TSet<URCAction*> */      __um(Actions);                                              // 0x0098   (0x0050)  
};
...
public:
	...
	// void OnPassed(class URCBehaviour* InBehaviour);                                                                          // [0x545c740] Native|Event|Public|BlueprintCallable|BlueprintEvent|Const 
	// Function /Script/RemoteControlLogic.RCBehaviourBindNode.IsSupported
	// bool IsSupported(class URCBehaviour* InBehaviour);                                                                       // [0x7a4acd0] Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	// Function /Script/RemoteControlLogic.RCBehaviourBindNode.Execute
	// bool Execute(class URCBehaviour* InBehaviour);                                                                           // [0x7a4ac30] Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
};
...
public:
	...
	// void PreExecute(class URCBehaviour* InBehaviour);                                                                        // [0x7a4aeb0] Native|Event|Public|BlueprintCallable|BlueprintEvent|Const 
	...
	// bool IsSupported(class URCBehaviour* InBehaviour);                                                                       // [0x7a4ad70] Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
...
public:
	...
	// bool IsSupported(class URCBehaviour* InBehaviour);                                                                       // [0x7a4ae10] Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	// Function /Script/RemoteControlLogic.RCBehaviourOnValueChangedNode.Execute
	// bool Execute(class URCBehaviour* InBehaviour);                                                                           // [0x7a4acd0] Native|Event|Public|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
};
...
public:
	...
	SDK_UNDEFINED(80,1239) /* TSet<URCBehaviour*> */   __um(Behaviours);                                           // 0x00E0   (0x0050)  
};
...
public:
	...
	SDK_UNDEFINED(80,1240) /* TSet<URCActionContainer*> */ __um(SharedActionContainers);                           // 0x0108   (0x0050)  
};
...
public:
	...
	// void TestIntFunction();                                                                                                  // [0x7a4af40] Final|Native|Public|BlueprintCallable 
};
